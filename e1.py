...
23/01/2023
ASIXc1C M03 UF1
Descripcion:Fer un programa de càlcul de temperatures del mar. Les tasques a fer són:
...
#Variables i constants definides
minim = PERIODE[0][0]
minim_2022 = PERIODE[0][0]
maxim = PERIODE[0][0]
maxim_2022 = PERIODE[0][0]
mitjana = 0
mitjana_2022 = 0
ANY = len(PERIODE)
#Calcul del maxim/minim/mitja revisant la taula sencera
for i in PERIODE[:]:
    for x in i[0:]:
        if x > minim:
            minim = x
        if x < maxim:
            maxim = x
        mitjana = mitjana + x
        #Calcul de la primera linea per calcular el any 2022
        if i == PERIODE[0]:
            if minim_2022 > x:
                minim_2022 = x
            if maxim_2022 < x:
                maxim_2022 = x
            mitjana_2022 = mitjana_2022 + x

print("Any 2022")
print("· Màxima:", (round(maxim_2022, 2)))
print("· Minim:", (round(minim_2022, 2)))
#Calcula de la mitjana corresponent
print("· Mitjana:", (round(mitjana_2022/12, 2)))
print("Període 2000 a 2022")
print("· Màxima:", maxim, )
print("· Minim:", minim, )
#Calcul de la mitjana corresponent
print("· Mitjana:", (round(mitjana/(12 * ANY), 2)))
